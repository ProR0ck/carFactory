...
$pass = '12345';
if($_POST['submit']){
 if($manager == $_POST['user'] AND $pass == ($_POST['pass'])){
	...
	<body>
		<div class="container">
			...
			<div class="content" style='height: 80%; width: 70%;'>
				<form method="post">
					<table>
						<caption>Введите данные специалиста по подбору персонала</caption>
						<tr><td>Логин:</td><td><input class='textedit' style='width: 230px;' type="text" name="user" required></td></tr>
						<tr><td>Пароль:</td><td><input class='textedit' style='width: 230px;' type="password" name="pass" required></td></tr>
						<tr><td></td><td></td></tr>
					</table>
