	...
	<body>
		<div class='container'>
			...
			<div class='content'>
				...
				<form action='new_worker_added.php'  method="post" name="form_id" onsubmit="javascript:return validate('form_id','email');" enctype="multipart/form-data">
				<div class='box'>
				<div class='frame'>
					...
					<table class='table_info'>
						...
						<tr>
							...
							<td><input type="radio" name="status_brigadier" value="нет" checked>нет <input type="radio" name="status_brigadier" value="да">да</td>
						</tr>
					</table>
